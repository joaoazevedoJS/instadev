...
class UserError extends Errors {
  ...
  private _errorCodeNotExists = this.FactoryErrors(
    404,
    'Code Not Exists! Verifed your code account!',
  );

  private _errorUserNameMalformed = this.FactoryErrors(
    400,
    'User_name Malformed',
  );
  ...
  private _errorExistsAccount = this.FactoryErrors(
    409,
    'E-mail or user_name exists, try again',
  );

  private _errorInvalidPassword = this.FactoryErrors(
    401,
  ...
  public userUpdate = (catchMsg: string) =>
    this.ResponseError(this._errorUserUpdate(catchMsg));

  public codeNotExists = () => this.ResponseError(this._errorCodeNotExists);

  public userNameMalformed = () =>
    this.ResponseError(this._errorUserNameMalformed);
  ...
  public userCreateAccount = (catchMsg: string) =>
    this.ResponseError(this._errorUserCreateAccount(catchMsg));
